...
def upgrade() -> None:
    ...
    op.create_table(
        "keywords",
        sa.Column(
            "id", sa.Integer(), nullable=False, primary_key=True, autoincrement=True, index=True
        ),
        sa.Column("case_id", sa.Integer(), nullable=False, index=True, primary_key=True),
        sa.Column("notifications_enabled", sa.Boolean(), nullable=False, default="False"),
    ...
    op.create_index(
        index_name="uq_keywords_query_type_case_id",
        table_name="keywords",
        columns=["query", "type", "case_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "crawled_at", sa.DateTime(timezone=True), nullable=False, server_default=func.now()
        ),
    )

    op.create_unique_constraint("uq_offers_url_case_id", "offers", columns=["url", "case_id"])
    ...
    items = [
        ...
        "https://www.imm.uzh.ch/",
        "https://www.ksw.ch/",
        "https://www.eawag.ch",
        "https://www.salt.ch/",
        "https://dialysezentrum.ch/",
        ...
        "https://www.euroimmun.ch/",
        "https://quorus.ch/",
        "https://www.jobscout24.ch/",
        "https://ch.jooble.org/",
        "https://www.jobs.ch/",
        "https://www.local.ch/",
        "https://www.swissfirms.ch/",
        "https://business-monitor.ch/",
        "https://search.ch/",
        "https://fr.glassdoor.ch/",
        "https://www.ikea.com/",
        "https://www.nespresso.com/",
        "https://www.bookbeat.ch/",
        "https://boris.unibe.ch/",
        "https://ethz.ch/",
        "https://www.ige.ch/",
        "https://www.localcities.ch/",
        "https://ch.linkedin.com/",
        "https://www.nzz.ch/",
        "https://www.centerpassage.ch/",
        "https://www.vd.ch/",
        "https://www.tuugo.ch/",
        "https://www.rhyathlon.ch/",
        "https://www.suedostschweiz.ch/",
        "https://www.wwf.ch/",
        "http://www.parcs.ch/",
        "https://www.tripadvisor.ch/",
        "https://www.monetas.ch/",
        "https://www.business-informations.ch/",
        "https://ar.ch/",
        "https://www.epfl.ch/",
        "https://www.seismoverlag.ch/",
        "https://www.psi.ch/",
        "https://www.webwiki.ch/",
        "https://www.medizinonline.ch",
        "http://admin.ch",
        "http://Tagesanzeiger.ch",
        "https://medical-tribune.ch/",
        "https://www.allbiz.ch/",
        "http://nau.ch",
        ...
        "https://zlmsg.ch/",
        "http://usz.ch",
        "http://familienleben.ch",
        "http://symptome.ch",
        "http://wireltern.ch",
        "https://www.cscq.ch/",
        "http://kindgesund.ch",
        "http://nespresso.com",
        "http://swissmedicinfo.ch",
        "http://baby-und-kleinkind.ch",
        "http://20minuti.ch",
        "https://m4.ti.ch/",
        "http://hplus-bildung.ch",
        "http://familienleben.ch",
        "http://bewusstgesund.ch",
        "http://medix-ticino.ch",
        "http://pharmasuisse.org",
        "http://impuls.migros.ch",
        ...
        "http://swoodoo.ch",
        "https://www.ksw.ch/",
        "http://www.pagesdor.ch/",
        "https://www.monetas.ch/",
        "https://tel.help.ch/",
        "https://www.webwiki.ch/",
        "https://www.rsi.ch/",
        "https://www.familienleben.ch/",
        "https://tesi.supsi.ch/",
        "https://de.glassdoor.ch/",
        "https://www.mediaplaner.ch/",
        "https://www.srf.ch/",
        "https://www.musiques-suisses.ch/",
        "https://edoc.unibas.ch/",
        "https://www.zora.uzh.ch/",
        "https://www.unispital-basel.ch/",
        "https://www.dcaf.ch/",
        "https://www.rf-partners.ch/",
        "https://www.eoc.ch/",
        "https://www.heckenpflanzendirekt.ch/",
        "https://www.lixt.ch/",
        "https://www.allbiz.ch/",
    ]
